...
def setupGenesis(env):
    ...
    env.cmd('ft.create', 'idx', 'EXPRESSION', 'prefix("gen1", @__key)', 'schema', 'txt', 'text')
...
def testSummarizationMultiField(env):
    ...
    env.cmd('FT.CREATE', 'idx', 'EXPRESSION', 'prefix("redis", @__key)', 'SCHEMA', 'txt1', 'TEXT', 'txt2', 'TEXT')
...
def testSummarizationDisabled(env):
    env.cmd('FT.CREATE', 'idx', 'EXPRESSION', 'prefix("doc", @__key)', 'NOOFFSETS', 'SCHEMA', 'body', 'TEXT')
    env.cmd('FT.ADD', 'idx', 'doc', 1.0, 'FIELDS', 'body', 'hello world')
    with env.assertResponseError():
        res = env.cmd('FT.SEARCH', 'idx', 'hello',
                       'SUMMARIZE', 'FIELDS', 1, 'body')

    env.cmd('FT.CREATE', 'idx2', 'EXPRESSION', 'prefix("doc", @__key)', 'NOHL', 'SCHEMA', 'body', 'TEXT')
...
def testSummarizationNoSave(env):
    env.skip()
    env.cmd('FT.CREATE', 'idx', 'EXPRESSION', 'prefix("doc", @__key)', 'SCHEMA', 'body', 'TEXT')
...
def testSummarizationMeta(env):
    env.cmd('ft.create', 'idx', 'EXPRESSION', 'prefix("doc", @__key)', 'schema', 'foo',
...
def testOverflow1(env):
    ...
    env.cmd('FT.CREATE', 'netflix', 'EXPRESSION', 'prefix("15", @__key)', 'SCHEMA', 'title', 'TEXT', 'rating', 'TEXT', 'leve', 'TEXT', 'description', 'TEXT', 'year', 'NUMERIC', 'uscore', 'NUMERIC', 'usize', 'NUMERIC')
...
def testIssue364(env):
    ...
    env.cmd('ft.create', 'idx', 'EXPRESSION', 'prefix("doc", @__key)', 'SCHEMA', 'building_type', 'TEXT', 'description', 'TEXT')
...
def testFailedHighlight(env):
    #test NOINDEX
    env.cmd('ft.create', 'idx', 'EXPRESSION', 'prefix("doc1", @__key)',
    ...
    #test empty string
    env.cmd('ft.create', 'idx2', 'EXPRESSION', 'prefix("doc2", @__key)',
    ...
    #test stop word list
    env.cmd('ft.create', 'idx3', 'EXPRESSION', 'prefix("doc3", @__key)',
            'SCHEMA', 'f1', 'TEXT', 'f2', 'TEXT', 'f3', 'TEXT')
