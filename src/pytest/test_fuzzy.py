...
def testBasicFuzzy(env):
    ...
    env.assertOk(r.execute_command(
        'ft.create', 'idx', 'EXPRESSION', 'prefix("doc", @__key)', 'schema', 'title', 'text', 'body', 'text'))
...
def testLdLimit(env):
    env.cmd('ft.create', 'idx', 'EXPRESSION', 'prefix("doc", @__key)', 'schema', 'title', 'text', 'body', 'text')
...
def testFuzzyWithNumbersOnly(env):
    env.expect('ft.create', 'idx', 'EXPRESSION', 'prefix("doc", @__key)', 'schema', 'test', 'TEXT', 'SORTABLE').equal('OK')
